...
Description: "Maps Uzbekistan local laboratory research codes to LOINC"
* url = "https://terminology.dhp.uz/fhir/core/ConceptMap/sr-lab-researchs-cm"
* version = "1.0.0"
* name = "SRLabResearchsCM"
* status = #draft
* experimental = true
* publisher = "Uzinfocom"
...
* group[=].element[=].target[=].display = "Platelet distribution width (PDW) [Entitic volume] by Automated count"
* group[=].element[=].target[=].relationship = #source-is-broader-than-target
...
* group[=].element[=].target[=].display = "Platelet large cell ratio [Ratio] in Blood by Automated count"
* group[=].element[=].target[=].relationship = #source-is-broader-than-target
...
* group[=].element[=].display = "Gepatit"
* group[=].element[=].target[+].code = #null
* group[=].element[=].target[=].display = "Hepatitis"
* group[=].element[=].target[=].relationship = #equivalent
